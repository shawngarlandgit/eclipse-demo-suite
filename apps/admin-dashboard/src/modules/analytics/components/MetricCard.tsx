 ...
 */
function MetricCard({ title, value, change, subtitle, icon: IconComponent, valueColor = 'white' }: MetricCardProps) {
  ...
  return (
    <Box className="card" p={6}>
      ...
      <Text fontSize="2xl" fontWeight="bold" color={valueColor} mb={1}>
        {value}
      </Text>
