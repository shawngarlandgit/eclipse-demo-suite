...
class ComplianceService {
   ...
   */
  async getComplianceSummary(_dateRange: DateRange): Promise<ComplianceSummary> {
   ...
   * Get audit logs
   */
  async getAuditLogs(_dateRange: DateRange, limit: number = 50): Promise<AuditLog[]> {
    await this.simulateDelay();
   ...
   */
  async getComplianceMetrics(_dateRange: DateRange): Promise<ComplianceMetrics> {
    await this.simulateDelay();
