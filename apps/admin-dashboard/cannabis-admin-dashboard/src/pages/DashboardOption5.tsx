...
function DashboardOption5() {
  ...
  return (
    <Box>
      ...
      {/* Compact Summary Row */}
      <Box bg="slate.800" borderRadius="md" p={4} mb={4}>
              ...
              <Table size="sm">
                <Thead>
                  <Tr>
                    ...
                    <Th color="slate.400" borderColor="slate.700" isNumeric>Items/Trans</Th>
                  </Tr>
                </Thead>
                <Tbody>
                  {staffPerformance?.map((staff, idx) => (
                    <Tr key={staff.staff_id} _hover={{ bg: 'slate.750' }}>
                      ...
                      <Td borderColor="slate.700">
                        <Text color="white" fontWeight="medium">{staff.staff_name}</Text>
                      </Td>
                      <Td borderColor="slate.700" isNumeric>
                        <Text color="green.400" fontWeight="bold">{formatCurrency(staff.total_sales)}</Text>
                      </Td>
                      <Td borderColor="slate.700" isNumeric>
                        <Text color="slate.300">{staff.transaction_count}</Text>
                      </Td>
                      <Td borderColor="slate.700" isNumeric>
                        <Text color="slate.300">{formatCurrency(staff.avg_transaction)}</Text>
                      </Td>
                      <Td borderColor="slate.700" isNumeric>
                        <Text color="slate.300">{(staff.items_per_transaction || 0).toFixed(1)}</Text>
                      </Td>
                    </Tr>
                  ))}
                </Tbody>
